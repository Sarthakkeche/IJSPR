...
//             <span>editorijrwsjournal@gmail.com</span>
//           </p>
//           <p className="flex items-center space-x-2 text-sm mb-2">
//             <Phone className="w-4 h-4 text-orange-400" />
//             <span>+91 9657778471</span>
//           </p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/archive" className="hover:text-orange-500">Archive</Link></li>
            <li><Link to="/Eboard" className="hover:text-orange-500">Editorial Board</Link></li>
        ...
        <div>
          <h4 className="text-orange-500 font-semibold text-sm mb-4">For Authors</h4>
          <ul className="space-y-2 text-sm">
            <li><Link to="/submit" className="hover:text-orange-500">Submit Manuscript</Link></li>
            <li><Link to="/subguide" className="hover:text-orange-500">Author Guidelines</Link></li>
            <li><Link to="/InfoAuthors" className="hover:text-orange-500">Information for Authors</Link></li>
            <li><Link to="/status" className="hover:text-orange-500">Check Status</Link></li>
            <li><Link to="/currentpage" className="hover:text-orange-500">Current Issue</Link></li>
          </ul>
        </div>
