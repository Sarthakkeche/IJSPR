      ...
      <section className="py-16 px-4 md:px-20 bg-white">
        ...
        >
          ...
          <div>
            ...
            <p className="mb-2">
              The International Journal of Scientific Research and Innovation (IJSRI), an official publication of IJSRI, is published by Medknow Publications, Mumbai, India, monthly in each year. Our website is SSL-certified (HTTPS):{" "}
