...
//    <>
//   <Helmet>
//   <title>IJRWS - International Journal of Research Welfare Society</title>
//   <meta 
//     name="description" 
//     content="Official homepage of the IJRWS, a peer-reviewed, open-access journal dedicated to publishing high-quality research." 
//   />
// </Helmet>
...
const Home = () => {
  ...
  // --- FIX 1: All useState hooks MUST be at the top ---
  const [stats, setStats] = useState([
    {
      icon: <Trophy size={36} className="text-orange-500" />,
      value: "0",
  ...
  // --- Const definitions are fine here ---
  const features = [
    {
      icon: <CheckCircle className="w-10 h-10 text-white" />,
      title: "Beginner-Friendly Publishing",
  ...
  // --- useEffect hooks are called AFTER useState ---
  useEffect(() => {
    AOS.init({ duration: 1000 });
  }, []);
  ...
  useEffect(() => {
    ...
    fetchStats();
  }, [OJS_API_URL, OJS_API_KEY]); // Added dependencies to the useEffect array
